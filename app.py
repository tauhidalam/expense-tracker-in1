...
@login_required
def debt_bucket_detail(bucket_id):
...
@app.route('/delete_debt_bucket/<int:bucket_id>', methods=['POST'])
@login_required
def delete_debt_bucket(bucket_id):
    bucket = DebtBucket.query.get(bucket_id)
